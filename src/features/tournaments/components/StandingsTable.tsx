import { StandingsRow, Entrant } from '../../../../shared/tournaments/types';
...
export function StandingsTable({ standings, entrants }: StandingsTableProps) {
  const { t } = useLanguage();
        ...
        <table className="w-full text-left text-xs sm:text-sm border-collapse">
          <thead>
            <tr className="border-b border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 font-medium">
              ...
              <th className="py-2 px-3">{t.tournament.entrantIndividual}</th>
              <th className="py-2 px-2 text-center">P</th>
              <th className="py-2 px-2 text-center">W</th>
              <th className="py-2 px-2 text-center">D</th>
              <th className="py-2 px-2 text-center">L</th>
              <th className="py-2 px-2 text-center hidden sm:table-cell font-mono">+ / -</th>
              <th className="py-2 px-2 text-center font-mono">Diff</th>
              <th className="py-2 px-3 text-center font-bold text-blue-600 dark:text-blue-400">Pts</th>
            </tr>
          </thead>
